...
function getTowRows() {
  return [...LIGHT_DUTY_TOW_ROWS, ...HD_TOW_ROWS];
}

function getPayloadRows() {
  return [...LIGHT_DUTY_PAYLOAD_ROWS, ...HD_PAYLOAD_ROWS];
}
